...
export const Register = ({ switchAuthHandler }) => {
  ...
  const isSubmitButtonDisable =
    !formData.DPI.isValid ||
    !formData.email.isValid ||
    !formData.name.isValid ||
    !formData.surname.isValid ||
    !formData.YYYY.isValid ||
    !formData.MM.isValid ||
    !formData.DD.isValid ||
    ...
    (userRole === 'ADMINISTRADOR-PLATAFORMA' && !formData.rol.isValid);
  ...
  const handleRegister = async (e) => {
    ...
    if (userRole === 'ADMINISTRADOR-PLATAFORMA') {
      registrationData.role = formData.rol.value;
    }
        ...
        <div className='general-container'>
          <div className="logo-container">
            ...
            <div className='title-container'>
              ...
              <h2 className="title-register">VOTANTES</h2>
            </div>
          ...
          <div className="first-inputs-container">
            ...
            <div className="input-container">
              <Input
                ...
                label={<label>Validar Contraseña</label>}
            ...
            {userRole === 'ADMINISTRADOR-PLATAFORMA' && (
              <div className="input-container">
                <label>Rol</label>
                <div className="select-wrapper">
                  <FaRegUser className="select-icon" />
                  <select
                    value={formData.rol.value}
                    onChange={(e) => handleValueChange(e.target.value, 'rol')}
                    onBlur={(e) => handleValidationOnBlur(e.target.value, 'rol')}
                  >
                    <option value="">Selecciona un rol para el usuario</option>
                    <option value="USUARIO">Usuario</option>
                    <option value="FUNCIONARIO">Funcionario</option>
                    <option value="ADMINISTRADOR-PLATAFORMA">Administrador de plataforma</option>
                    <option value="ADMINISTRADOR-PARTIDO">Administrador de partido</option>
                  </select>
                </div>
                {formData.rol.showError && (
                  <span className="validation-message">
                    {selectValidationMessage}
                  </span>
                )}
